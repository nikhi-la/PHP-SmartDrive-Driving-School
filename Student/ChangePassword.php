...
{
	$sel="select * from tbl_student where student_password='".$_POST["txtcurrent"]."' and student_id='".$_SESSION["uid"]."'";
		$row=$con->query($sel);
		...
		else
		{
			...
			if($_POST["txtnew"]==$_POST["txtconfirm"])
			{
				...
				$updateQry="update tbl_student set student_password='".$_POST["txtnew"]."' where student_id='".$_SESSION["uid"]."'";
