...
if(isset($_GET["cpid"]))
{
	$_SESSION["cpid"]=$_GET["cpid"];
}
$curdate = date('d-m-y');
$selQry="select * from tbl_customizepackage c inner join tbl_student s inner join tbl_district d inner join tbl_vehicletype v on c.student_id=s.student_id and d.district_id=s.district_id and c.vehicle_type=v.vehicletype_id  where c.customization_id='".$_SESSION["cpid"]."'";
	...
	<div class="invoice_container">
			...
			<div class="in_details">
				...
				<table>
					<tr>
						<td>Invoice No</td>
						<td>:</td>
						<td><b><?php echo $data["customization_id"]; ?></b></td>
					</tr>
					<tr>
						<td>Date</td>
						<td>:</td>
		...
		<div class="product_container">
			<table width="83%" border="1" cellspacing="0" class="item_table">
				...
				<tr>
                   <td><p>Vehicle Name :<?php echo ucfirst($data["vehicle_name"]); ?></p>
                    <p>Vehicle Number :<?php echo $data["vehicle_number"]; ?></p>
                    <p>Details :<?php echo $data["course_duration"]; ?> Days </p>
                    <p>Vehicle Type :<?php echo ucfirst($data["vehicletype_name"]); ?></p>
				    <p>&nbsp;</p>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p></td>
					<td><p><?php echo $data["course_amount"]; ?> INR</p>
				    <p><?php 
					$words=displaywords($data["course_amount"]);
					echo $words; ?></p>
				    <p>&nbsp;</p>
				    <p>&nbsp;</p>
				    <p>&nbsp;</p>
