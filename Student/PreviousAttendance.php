...
<p>&nbsp;</p>
  <table width="926" height="102"  border="1" align="center"  cellpadding="10">
    <tr>
  ...
  <div id="pri">
    <table width="590" height="91"  border="1" align="center" cellpadding="10">
    <tr>
      <th height="44" >Sl.no</th>
    ...
    <?php
	$sel="select * from  tbl_studentattendance where student_id='".$_SESSION["uid"]."' ";
	...
	$sel=$sel . "order by attendance_date";
