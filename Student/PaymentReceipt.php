...
$curdate = date('d-m-y');
$selQry="select * from tbl_packagebooking p inner join tbl_student s inner join tbl_district d inner join tbl_package pa inner join tbl_packagetype pt  inner join tbl_vehicletype vt on p.student_id=s.student_id and d.district_id=s.district_id and pa.package_id=p.package_id and pa.vehicletype_id=vt.vehicletype_id and pa.packagetype_id=pt.packagetype_id where p.packagebooking_id='".$_SESSION["pid"]."'";
	...
	<div class="invoice_container">
			...
			<div class="in_details">
				...
				<table>
					<tr>
						<td>Invoice No</td>
						<td>:</td>
						<td><b><?php echo $data["packagebooking_id"]; ?></b></td>
					</tr>
					<tr>
						<td>Date</td>
						<td>:</td>
		...
		<div class="product_container">
			<table width="83%" border="1" cellspacing="0" class="item_table">
				...
				<tr>
                   <td><p>Package Name :<?php echo ucfirst($data["package_name"]); ?></p>
                    <p>Package Type :<?php echo ucfirst($data["packagetype_name"]); ?></p>
                    <p>Details :<?php echo $data["package_details"]; ?></p>
                    <p>Vehicle Type :<?php echo ucfirst($data["vehicletype_name"]); ?></p>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p>
                    <p>&nbsp;</p></td>
					<td><p><?php echo $data["package_amount"]; ?> INR</p>
				    <p><?php 
					$words=displaywords($data["package_amount"]);
					echo $words; ?></p>
				    <p>&nbsp;</p>
				    <p>&nbsp;</p>
				    <p>&nbsp;</p>
