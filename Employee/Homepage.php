...
<body>
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="../Assets/Template/Employee/img\image-1.jpg" alt="Image" >
                ...
                <div class="carousel-item">
                    <img class="w-100" src="../Assets/Template/Employee/img/carousel-1.jpg" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
				   ...
				   <li class="breadcrumb-item small"><i class="fa fa-calendar-alt text-primary me-2"></i>30 Days</li>
                        ...
                        <div class="position-relative mt-auto">
                            <img class="img-fluid" src="../Assets/Template/Employee/img/4wheeler.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
				   ...
				   <li class="breadcrumb-item small"><i class="fa fa-calendar-alt text-primary me-2"></i>30 Days</li>
                        ...
                        <div class="position-relative mt-auto">
                            <img class="img-fluid" src="../Assets/Template/Employee/img/bus.jpg" alt="">
  ...
  <!-- Footer Start -->
        ...
        <div class="container" >
            <div class="row g-5" >
                <div class="col-lg-3 col-md-6">
                    ...
                    <h5 class="text-white mb-4"><img src="../Assets/Template/Employee/img/Sd.png" width="20" height="20" me-3> SMART DRIVE</h5>
    ...
    <script src="../Assets/Template/Employee/lib/wow/wow.min.js"></script>
    <script src="../Assets/Template/Employee/lib/easing/easing.min.js"></script>
    <script src="../Assets/Template/Employee/lib/waypoints/waypoints.min.js"></script>
    <script src="../Assets/Template/Employee/lib/owlcarousel/owl.carousel.min.js"></script>

    <!-- Template Javascript -->
    <script src="../Assets/Template/Employee/js/main.js"></script>
</body>
