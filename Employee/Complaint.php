...
$insQry="insert into tbl_complaint(complaint_id,complaint_content,complaint_date,emp_id)values('".$compid."','".$complaint."',curdate(),'".$_SESSION["uid"]."')";
if($con->query($insQry))
{
		?>
...
<form id="form1" name="form1" method="post" action="">
  ...
  <table  border="1" cellpadding="10">
    ...
    <?php
    $selQry="select * from tbl_complaint where emp_id='".$_SESSION["uid"]."'";
