...
<title>License Test Report</title>
...
<p>&nbsp;</p>
<h1>License Test Report</h1>
<p>&nbsp;</p>
  <table width="885" height="122"  border="1" align="center"  cellpadding="10">
    <tr>
      <td width="102">From Date<span class="required">  *</span></td>
      <td width="289"><label for="txt_f"></label>
      <input type="date" name="txtfrom" id="txtfrom" min="2000-01-01" max=<?php echo date('Y-m-d', strtotime('+242 days'));?> /></td>
      <td width="93">To Date<span class="required">  *</span></td>
  ...
  <div id="pri">
    ...
    <?php
	$date="0000-00-00";
	$sel="select * from  tbl_licensetest lt inner join tbl_license l inner join tbl_student s on lt.license_id=l.license_id and l.student_id=s.student_id where test_date!='".$date."'";
	if($_POST["txtfrom"]!="" && $_POST["txtto"]!="")
	{
		$sel = $sel ." and test_date between '".$_POST["txtfrom"]."' and '".$_POST["txtto"]."' ";
	}
	if($_POST["txtfrom"]!="" && $_POST["txtto"]=="")
	{
		$sel = $sel ." and test_date between '".$_POST["txtfrom"]."' and curdate() ";
	}
	if($_POST["txtto"]!="" && $_POST["txtfrom"]=="")
	{
		$sel = $sel ." and test_date < '".$_POST["txtto"]."'";
	}
