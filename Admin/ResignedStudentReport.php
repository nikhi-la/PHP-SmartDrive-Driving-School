...
<p>&nbsp;</p>
  ...
  <div id="pri">
    ...
    <?php
    $sel1="select * from tbl_studentdeparture ";

	if($_POST["txtfrom"]!="" && $_POST["txtto"]!="")
	{
		$sel1 = $sel1 ." where student_departuredate between '".$_POST["txtfrom"]."' and '".$_POST["txtto"]."'";
	}
	if($_POST["txtfrom"]!="" && $_POST["txtto"]=="")
	{
		$sel1 = $sel1 ." where student_departuredate between '".$_POST["txtfrom"]."' and curdate()";
	}
	if($_POST["txtto"]!="" && $_POST["txtfrom"]=="")
	{
		$sel1 = $sel1 ."where student_departuredate <= '".$_POST["txtto"]."'";
	}
    ...
    <td><?php echo ucfirst($data1["student_name"])." ".ucfirst($data1["student_middle"])." ".ucfirst($data1["student_last"]);?></td>
     <td><?php echo $data1["student_contact"];?></td>
         ...
         <td><?php echo $data1["student_departuredate"];?> </td>
      </tr>
          <?php
	}
