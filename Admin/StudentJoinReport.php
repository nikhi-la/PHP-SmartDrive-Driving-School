...
<p>&nbsp;</p>
  <table width="865" height="123"  border="1" align="center"  cellpadding="10">
    <tr>
      ...
      <input type="date" name="txtfrom" id="txtfrom"  max="<?php  echo date('Y-m-d'); ?>"/></td>
      <td width="91">To Date<span class="required">  *</span></td>
      <td width="292"><label for="txt_t"></label>
      <input type="date" name="txtto" id="txtto"  max="<?php  echo date('Y-m-d'); ?>"/></td>
    </tr>
    <tr>
  ...
  <div id="pri">
	...
	{
		$sel = $sel ." where student_doj between '".$_POST["txtfrom"]."' and '".$_POST["txtto"]."'";
	}
	if($_POST["txtfrom"]!="" && $_POST["txtto"]=="")
	{
		$sel = $sel ." where student_doj between '".$_POST["txtfrom"]."' and curdate()";
	}
	if($_POST["txtto"]!="" && $_POST["txtfrom"]=="")
	{
		$sel = $sel ." where student_doj < '".$_POST["txtto"]."'";
	}
