...
<title>Booked Not Payed Report</title>
...
<p>&nbsp;</p>
<h1>Package Booked Not Payed Report</h1>
<p>&nbsp;</p>
  <table width="869" height="121"  border="1" align="center"  cellpadding="10">
    <tr>
  ...
  <div id="pri">
    ...
    <?php
	$sel="select * from  tbl_package p inner join tbl_packagebooking pb inner join tbl_student s on p.package_id=pb.package_id and pb.student_id=s.student_id where pb.packagebooking_status=1 and pb.packagepayment_status=0";
	
	
	if($_POST["txtfrom"]!="" && $_POST["txtto"]!="")
	{
		$sel = $sel ." and packagebooking_date between '".$_POST["txtfrom"]."' and '".$_POST["txtto"]."'";
	}
	if($_POST["txtfrom"]!="" && $_POST["txtto"]=="")
	{
		$sel = $sel ." and packagebooking_date between '".$_POST["txtfrom"]."' and curdate()";
	}
	if($_POST["txtto"]!="" && $_POST["txtfrom"]=="")
	{
		$sel = $sel ." and packagebooking_date < '".$_POST["txtto"]."'";
	}
