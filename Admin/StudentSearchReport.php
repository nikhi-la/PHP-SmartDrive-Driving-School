...
<p>&nbsp;</p>
  <table width="498" height="121"  border="1" align="center"  cellpadding="10">
    <tr>
      <td width="149">Student Name<span class="required">  *</span></td>
  ...
  <div id="pri">
    <table width="925" height="119"  border="1" align="center" cellpadding="10">
    <tr>
	...
	$sel="select * from  tbl_student where student_name='".$name."' or student_middle='".$middle."' or student_last='".$last."'";
