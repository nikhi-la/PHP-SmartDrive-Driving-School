...
$insQry="insert into tbl_empdeparture(emp_id,emp_name,emp_middle,emp_last,emp_dob,emp_gender,district_id,emp_place,emp_landmark,emp_housename,emp_pincode,emp_email,emp_contact,emp_photo,emp_proof,emp_password,emp_doj,emp_departuredate)values('".$employeeid."','".$first."','".$middle."','".$last."','".$dob."','".$gender."','".$district."','".$place."','".$landmark."','".$housename."','".$pincode."','".$email."','".$contact."','".$photo."','".$proof."','".$password."','".$doj."',curdate())";
...
if($con->query($insQry))
{
	...
	location.href="ViewEmployee.php";
	</script>
<?php
  ...
  <table width="1227" height="98" border="1" cellpadding="10">
	...
	<td><center><a href="../Assets/Files/employeeProof/<?php echo $data["emp_proof"];?>" download>
     <i class="fa fa-download " style="font-size:48px;cursor: pointer;color:black;"></i></center></td>
      <td><a href="ViewEmployee.php?did=<?php echo $data["emp_id"];?>">Remove Resigned</a></td>
    </tr>
    <?php
	}
	?>
