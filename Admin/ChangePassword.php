...
{
	$sel="select * from tbl_admin where admin_password='".$_POST["txtcurrent"]."' and admin_id='".$_SESSION["uid"]."'";
		$row=$con->query($sel);
		   		...
		   		if(!$uppercase || !$lowercase || !$number || strlen($_POST["txtnew"]) < 8 || $_POST["txtnew"]=="") 
				...
				else
					{
						if($_POST["txtnew"]==$_POST["txtconfirm"])
						  {
		        			$updateQry="update tbl_admin set admin_password='".$_POST["txtnew"]."' where admin_id='".$_SESSION["uid"]."'";
...
<form id="form1" name="form1" method="post" action="">
  ...
  <p>&nbsp;</p>
  <table width="463" height="207" border="1" cellpadding="10">
    <tr>
      <td width="147">Current Password<span class="required">  *</span></td>
      <td width="264"><label for="txtcurrent"></label>
    ...
    <tr>
      ...
      <td><div class="input-group"><label for="txtconfirm"></label>
      <input type="password" name="txtconfirm" id="txtconfirm" onkeyup="validateConfirmPassword()" required="required" autocomplete="off"/>
      <span id="scpassword"></span></div>
      </td>
    </tr>
    <tr>
