...
function validateMiddleName(elem)
{
var nameexp=/^([A-Za-z ]*)$/;
	if(elem.value.match(nameexp))
	{
	...
	else
	{
		...
		document.getElementById("middle").innerHTML = "<span  style='color: red;text: 12px;font-size: 14px;'>Alphabets Are Allowed</span>";
		elem.focus();
		return false;
	}  
}
...
var nameexp=/^([A-Za-z ]*)$/;
	...
	else
	{
		...
		document.getElementById("last").innerHTML = "<span  style='color: red;text: 12px;font-size: 14px;'>Alphabets Are Allowed</span>";
		elem.focus();
		return false;
	}  
}
...
var nameexp=/^([A-Za-z ]*)$/;
	...
	else
	{
		...
		document.getElementById("city").innerHTML = "<span  style='color: red;text: 12px;font-size: 14px;'>Alphabets Are Allowed</span>";
		elem.focus();
		return false;
	}  
}
...
{
	var nameexp = /^[0-9 ]+$/;
	 if(elem.value.match(nameexp) && (elem.value.length==6))
       {
