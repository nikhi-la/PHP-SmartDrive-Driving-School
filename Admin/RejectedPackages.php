...
?>
<script>
window.location="RejectedPackages.php";
</script>
<?php
}
}
...
$updateQry1="update tbl_customizepackage set booking_status=1 where customization_id='".$_GET["caid"]."'";
if($con->query($updateQry1))
{
    $mail = new PHPMailer(true);
...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="1091" height="50" border="1" cellpadding="10">
	...
	<tr>
      ...
      <td>&nbsp;<a href="RejectedPackages.php?aid=<?php echo $data["packagebooking_id"] ?>">Accept</a>
    </tr>
    <?php
	}
	?>
    ...
    <p>&nbsp;</p>
   <p>&nbsp;</p>
   <h1>Rejected Custom Packages List</h1>
   <p>&nbsp;</p>
  <table width="1091" height="50" border="1" cellpadding="10">
    <tr>
      <th>Sl.No</th>
    ...
    <?php
    $selQry2="select * from tbl_customizepackage c inner join tbl_vehicletype v inner join tbl_student s on c.vehicle_type=v.vehicletype_id and c.student_id=s.student_id where booking_status=2 ";
...
while($data1=$row1->fetch_assoc())
{
    ...
    <tr>
     ...
     <td>&nbsp;<?php echo ucfirst($data1["student_name"])." ".ucfirst($data1["student_middle"])." ".ucfirst($data1["student_last"])  ?></td>
      ...
      <td>&nbsp;<a href="RejectedPackages.php?caid=<?php echo $data1["customization_id"] ?>">Accept</a>
    </tr>
    <?php
}
	?>
